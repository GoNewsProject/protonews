...
const (
	CommentService_AddComment_FullMethodName  = "/comment.v1.CommentService/AddComment"
	CommentService_GetComments_FullMethodName = "/comment.v1.CommentService/GetComments"
)
